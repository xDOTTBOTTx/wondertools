      ...
      <form wire:submit.prevent="onYoutubeTitleGenerator">
            ...
            @if ( !empty($temp_data) )
                    <fieldset class="form-fieldset mt-3">
                        <div class="form-group">
                            <label class="form-label">{{ __('Click on a title you like if you want to temporarily store it in the box below.') }}</label>
                ...
                @if ( !empty($data) )
                    <fieldset class="form-fieldset mt-3">
                        <div class="form-group mb-3">
                          <label class="form-label">{{ __('Your title list') }}</label>
