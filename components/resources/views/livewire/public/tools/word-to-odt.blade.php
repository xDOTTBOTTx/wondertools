<div>
      <form wire:submit.prevent="onWordToOdt">
                      ...
                      <div class="row w-100">
                          <div class="col">
                            <div class="form-group">
                              <input type="file" class="form-control" wire:model.defer="local_file" accept=".docx,.doc" {{ $convertType == 'localFile' ? 'required' : '' }}>
                            </div>
                          </div>
        ...
        <div class="form-group">
            <button class="btn btn-info mx-auto d-block" wire:loading.attr="disabled">
                <span>
                    <div wire:loading.inline wire:target="onWordToOdt">
                        <x-loading />
                    </div>
                    <span wire:target="onWordToOdt">{{ __('Convert') }}</span>
                </span>
            </button>
        </div>
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>{{ __('Thank you for using our service. If you can share our website with your friends, it will be a great help.') }}</p>
                </div>
