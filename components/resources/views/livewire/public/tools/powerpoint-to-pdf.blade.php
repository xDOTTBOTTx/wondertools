<div>
      <form wire:submit.prevent="onPowerpointToPdf">
                      ...
                      <div class="row w-100">
                          <div class="col">
                            <div class="form-group">
                              <input type="file" class="form-control" wire:model.defer="local_file" accept=".pptx,.ppt" {{ $convertType == 'localFile' ? 'required' : '' }}>
                            </div>
                          </div>
        ...
        <div class="form-group">
            <button class="btn btn-info mx-auto d-block" wire:loading.attr="disabled">
                <span>
                    <div wire:loading.inline wire:target="onPowerpointToPdf">
                        <x-loading />
                    </div>
                    <span wire:target="onPowerpointToPdf">{{ __('Convert') }}</span>
                </span>
            </button>
        </div>
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>{{ __('Note: This is a preview only. Click the "Download File" button for the final file.') }}</p>
                </div>
