<div>
      <form wire:submit.prevent="onWebpToPdf">
                      ...
                      <div class="row w-100">
                          <div class="col">
                            <div class="form-group">
                              <input type="file" class="form-control" wire:model.defer="local_file" accept=".webp" {{ $convertType == 'localFile' ? 'required' : '' }}>
                            </div>
                          </div>
        ...
        <div class="form-group">
            <button class="btn btn-info mx-auto d-block" wire:loading.attr="disabled">
                <span>
                    <div wire:loading.inline wire:target="onWebpToPdf">
                        <x-loading />
                    </div>
                    <span wire:target="onWebpToPdf">{{ __('Convert') }}</span>
                </span>
            </button>
        </div>
