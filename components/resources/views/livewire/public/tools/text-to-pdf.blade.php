<div>
      <form wire:submit.prevent="onTextToPdf">
                      ...
                      <div class="row w-100">
                          <div class="col">
                            <div class="form-group">
                              <input type="file" class="form-control" wire:model.defer="local_file" accept=".txt" {{ $convertType == 'localFile' ? 'required' : '' }}>
                            </div>
                          </div>
        ...
        <div class="form-group">
            <button class="btn btn-info mx-auto d-block" wire:loading.attr="disabled">
                <span>
                    <div wire:loading.inline wire:target="onTextToPdf">
                        <x-loading />
                    </div>
                    <span wire:target="onTextToPdf">{{ __('Convert') }}</span>
                </span>
            </button>
        </div>
