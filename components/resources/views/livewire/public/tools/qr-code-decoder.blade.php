<div>
      <form wire:submit.prevent="onQrCodeDecoder">
                        ...
                        <div class="row w-100">
                            <div class="col">
                              <div class="form-group">
                                <input type="file" class="form-control" accept=".jpg,.jpeg,.png" wire:model.defer="local_image" {{ $convertType == 'localImage' ? 'required' : '' }}>
                              </div>
                            </div>
          ...
          <div class="form-group">
              <button class="btn btn-info mx-auto d-block" wire:loading.attr="disabled">
                <span>
                  <div wire:loading.inline wire:target="onQrCodeDecoder">
                    <x-loading />
                  </div>
                  <span>{{ __('Decode') }}</span>
                </span>
