<div>
      <form wire:submit.prevent="onJpgToPdf">
                      ...
                      <div class="row w-100">
                          <div class="col">
                            <div class="form-group">
                              <input type="file" class="form-control" wire:model.defer="local_file" accept=".jpg,.jpeg" {{ $convertType == 'localFile' ? 'required' : '' }}>
                            </div>
                          </div>
        ...
        <div class="form-group">
            <button class="btn btn-info mx-auto d-block" wire:loading.attr="disabled">
                <span>
                    <div wire:loading.inline wire:target="onJpgToPdf">
                        <x-loading />
                    </div>
                    <span wire:target="onJpgToPdf">{{ __('Convert') }}</span>
                </span>
            </button>
        </div>
