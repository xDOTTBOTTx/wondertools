...
class Create extends Component
{
    ...
    {
        //Meta
        $title = __('Create Post Translation') . ' ' . env('APP_SEPARATOR') . ' ' . env('APP_NAME');
        SEOMeta::setTitle($title);

        return view('livewire.admin.posts.translations.create')->layout('layouts.admin', [
            'breadcrumbs' => [
                ['title' => __( 'Admin' ), 'url' => route('admin.dashboard.index')],
                ['title' => __( 'Posts' ), 'url' => route('admin.posts.index')],
                ['title' => __( 'Translations' ), 'url' => route('admin.posts.translations.index', ['page_id' => $this->pageId])],
    ...
    **/
    ...
    /**
     * -------------------------------------------------------------------------------
     *  onCreatePostTranslation
     * -------------------------------------------------------------------------------
    **/
    public function onCreatePostTranslation()
    {
        $this->validate([
            'title' => 'required'
        ]);
