...
class RtfToPdf extends Component
{
    ...
    {
        return view('livewire.public.tools.rtf-to-pdf');
    }
...
/**
    ...
    public function onRtfToPdf()
    {
        ...
        try {
            ...
            if ($this->isValidFile($filePath)) {
                ...
                $this->addError('error', __('The file must be of type: rtf.'));
            }
    ...
    private function validateInputs()
    {
        $validationRules = $this->convertType == 'remoteURL'
            ...
            : ['local_file' => 'required|mimes:rtf|file|max:' . 1024 * General::first()->file_size];
    ...
    private function isValidFile($filePath)
    {
        ...
        return in_array($fileExtension, ['rtf']);
    }
