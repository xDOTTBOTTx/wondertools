...
class OdtToPdf extends Component
{
    ...
    {
        return view('livewire.public.tools.odt-to-pdf');
    }
    ...
    public function onOdtToPdf()
    {
        ...
        try {
            ...
            if ($this->isValidFile($filePath)) {
                ...
                $this->addError('error', __('The file must be of type: odt.'));
            }
    ...
    private function validateInputs()
    {
        $validationRules = $this->convertType == 'remoteURL'
            ...
            : ['local_file' => 'required|mimes:odt|file|max:' . 1024 * General::first()->file_size];
    ...
    private function isValidFile($filePath)
    {
        ...
        return in_array($fileExtension, ['odt']);
    }
