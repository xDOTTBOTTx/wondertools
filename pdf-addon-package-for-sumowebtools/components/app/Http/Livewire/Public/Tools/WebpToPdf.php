...
use App\Classes\WebpToPdfClass;
...
class WebpToPdf extends Component
{
    ...
    {
        return view('livewire.public.tools.webp-to-pdf');
    }
    ...
    public function onWebpToPdf(){
        ...
        try {
            ...
            if ($this->isValidFile($filePath)) {
                ...
                $this->addError('error', __('The file must be of type: webp.'));
            }
    ...
    **/
    private function validateInputs()
    {
        $validationRules = $this->convertType == 'remoteURL'
            ...
            : ['local_file' => 'required|mimes:webp|file|max:' . 1024 * General::first()->file_size];
    ...
    **/
    private function isValidFile($filePath)
    {
        ...
        return in_array($fileExtension, ['webp']);
    }
